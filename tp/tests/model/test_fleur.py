...
class TestFleur(TestCase):
    ...
    def testCedePollenCasSucces(self):
        # Etant donné une fleur
        uneFleur = Fleur("@", 500, Position(5, 12))
        # Quand elle cede 300 de pollen
        uneFleur.cedePollen(300)
